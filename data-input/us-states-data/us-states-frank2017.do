...
// You need to run the beginning of "main.do" in Github folder before running this.
...
generate method = ""
replace method = "Assuming the same distribution as fiscal income." if substr(widcode,1,6) == "sptinc"
replace source = "WID.world computations using: Frank, Sommeiller, Price & Saez (2015); " if substr(widcode,1,6) == "sptinc"

gen author="frank2017"

save "$us_states_data/us-states-frank2017.dta", replace
