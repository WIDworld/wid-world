...
replace geoundet = "MENAOIL" if inlist(iso, "AE", "BH", "IQ", "IR") | inlist(iso, "KW", "OM", "QA", "SA", "YE")
replace geoundet = "MENANONOIL" if inlist(iso, "EG", "DZ", "IL", "JO", "LB") | inlist(iso,"LY", "MA", "PS", "SY", "TN", "TR")
