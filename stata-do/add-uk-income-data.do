...
import excel "$wid_dir/Country-Updates/UK/2017_August/UK_NI_1990-2014.xlsx", sheet("series") first clear
renvars _all, lower
...
foreach year in `years'{
	qui{
		if "`type'"=="fiinc"{
		import excel "$wid_dir/Country-Updates/UK/2017_August/UK_FI_1990-2014.xlsx", ///
		sheet("total, UK, `year'") first clear
		}
		if "`type'"=="ptinc"{
		import excel "$wid_dir/Country-Updates/UK/2017_August/UK_NI_1990-2014.xlsx", ///
		sheet("total, UK, `year'") first clear
		}
