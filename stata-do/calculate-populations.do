...
// Note:
// In January 2024, npopul014 (ages 0–14) and npopul156 (ages 15–64) were added,
// along with the regions OK, OL, OO, OP, and OQ. These new regions are calculated 
// only for population variables in this Do-file. The rest of the variables are 
// calculated in aggregate-macro-regions.do. These regions should be deleted as 
// soon as the new region definitions are launched.
...
*Append gender/age breakdowns for coreterritories and poptot for extended core territories
...
*014 The population is comprised of individuals in the 0 to 14 age group.
	g valuenpopul014`gender'=valuenpopul001`gender'+valuenpopul051`gender'+valuenpopul101`gender' 
	* 156 The population is comprised of individuals in the 15 to 64 age group.
	g valuenpopul156`gender'=valuenpopul999`gender'-valuenpopul997`gender'-(valuenpopul001`gender'+valuenpopul051`gender'+valuenpopul101`gender') 
}
...
reshape long value, i( year widcode) j(iso) string
